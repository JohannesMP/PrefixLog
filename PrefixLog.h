 ...
 *
 * You may use this code (and by "code" I mean *anything* contained within 
 * in this project) for whatever you want. Personal use, Educational use, 
 * Corporate use, Military use, and all other uses are OK!
 *
 * I offer no warranty on anything, ever. I've tried to ensure that there are 
 * no gaping security holes where using this software might automatically send
 * your credit card information to aliens or erase your entire hard drive, but
 * it might happen. I'm sorry. However, I warned you, so you can't sue me.
 ...
 *
 * If you add a new feature or fix a bug, it would be nice if you contributed it
 * back to the project, but you don't have to. The repository/site you obtained
 * this software from should contain a way for you to contact me. 
 * Contributing to open source makes you awesome!
 *
 * If you use this software, you may delete this license, and don't have to give
 * me any credit, but it would be great if you did.
 *
